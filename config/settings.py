...
DISQUS_WEBSITE_SHORTNAME = 'Dstagram-jiyeon' # Disqus 사이트에 작성한 이름을 써야함
SITE_ID = 1 # sites 앱에 등록된 현재 사이트의 번호, 기본적으로 1번으로 설
...
SECRET_KEY = '82tog*5ll=0+$u2lbpdru6(=f9d0bkp73y@*sr=vy_&56_28y2'
